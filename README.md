# 超链接RESTful API设计模式
- [超链接RESTful API设计模式](#---restful-api----)
  * [0、前言](#0---)
  * [1、域名](#1---)
  * [2、版本（Versioning）](#2----versioning-)
  * [3、路径（Endpoint）](#3----endpoint-)
  * [4、HTTP动词](#4-http--)
  * [5、过滤信息（Filtering）](#5------filtering-)
  * [6、状态码（Status Codes）](#6-----status-codes-)
  * [7、错误处理（Error handling）](#7------error-handling-)
  * [8、返回结果](#8-----)
  * [9、超媒体](#9----)
  * [10、状态转换(HATEOAS)](#10------hateoas-)
  * [11、API入口点](#11-api---)
  * [12、为什么这样做有用，缺点是什么？](#12----------------)
    + [这些观点都很好，但是不利之处是什么？](#------------------)
  * [13、RESTful API是无状态的，那么身份认证是不是RESTful](#13-restful-api---------------restful)
    + [会话状态](#----)
    + [无状态约束](#-----)
    + [认证和授权](#-----)
    + [基于状态的Web服务](#-----web--)
    + [基于无状态的Web服务](#------web--)
    + [总结两者的区别](#-------)
  * [14、RESTful API的安全问题](#14-restful-api-----)
  * [15、参考文献](#15-----)
